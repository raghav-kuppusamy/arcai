...
export const mockEpics: Epic[] = [
  ...
  },
  {
    ...
    description: 'Integrate multiple payment gateways for secure and seamless transactions',
    status: 'planning',
    priority: 'high',
  ...
  },
  {
    ...
    description: 'Implement real-time notifications for users to stay updated on system events and alerts',
    status: 'refined',
    priority: 'medium',
  ...
  },
  {
    ...
    description: 'Add functionality to export data to CSV/Excel for reporting and analysis',
    status: 'in-review',
    priority: 'medium',
...
export const mockMilestones: Milestone[] = [
  {
    ...
    endDate: '2026-02-28',
    status: 'completed',
    goals: ['Implement OAuth2 authentication flow'],
  ...
  },
  {
    ...
    endDate: '2026-03-31',
    status: 'completed',
    goals: ['Integrate Stripe payment gateway'],
    completionPercentage: 100,
    epics: ['PROJ-1001'],
    signOffRequired: true,
    signedOff: true,
    signedOffBy: 'Sarah Chen',
    signedOffDate: '2026-03-31',
  },
  {
    id: 'ms-003',
    name: 'Sprint 3',
    ...
    endDate: '2026-04-30',
    status: 'completed',
    goals: ['Develop admin dashboard analytics'],
    completionPercentage: 100,
    epics: ['PROJ-1002'],
    signOffRequired: true,
    signedOff: true,
    signedOffBy: 'Emma Davis',
    signedOffDate: '2026-04-30',
  },
  {
    id: 'ms-004',
    name: 'Sprint 4',
    ...
    endDate: '2026-05-31',
    status: 'completed',
    goals: ['Implement real-time notifications'],
    completionPercentage: 100,
    epics: ['PROJ-1003'],
    signOffRequired: true,
    signedOff: true,
    signedOffBy: 'Sarah Chen',
    signedOffDate: '2026-05-31',
  },
  {
    id: 'ms-005',
    name: 'Sprint 5',
    ...
    endDate: '2026-06-30',
    status: 'completed',
    goals: ['Add CSV/Excel export functionality'],
    completionPercentage: 100,
    epics: ['PROJ-1004'],
    signOffRequired: true,
    signedOff: true,
    signedOffBy: 'Alex Kumar',
    signedOffDate: '2026-06-30',
  },
];
...
export const mockSignOffs: SignOff[] = [
  ...
  },
  {
    ...
    respondedDate: '2026-03-31',
    comments: 'Code quality and functionality verified',
  },
  {
    id: 'so-003',
    milestone: 'ms-003',
...
export const mockUserStories: UserStory[] = [
  ...
  },
  {
    ...
    daysInStatus: 2,
    type: 'defect',
    blockers: ['Waiting for QA environment'],
    epicKey: 'PROJ-1000',
  },
  {
    id: 'us-004',
...
export const mockDeployments: Deployment[] = [
  {
    ...
    environment: 'prod',
    status: 'success',
    deployedAt: '2026-03-06T10:00:00Z',
    deployedBy: 'CI/CD Pipeline',
    duration: 8,
    features: ['PROJ-1240', 'PROJ-1241'],
    defectsFixes: ['PROJ-1242'],
  },
  {
    id: 'dep-002',
    version: 'v2.5.0',
    environment: 'uat',
    status: 'success',
    deployedAt: '2026-03-07T08:00:00Z',
  ...
  },
  {
    ...
    environment: 'qa',
    status: 'success',
    deployedAt: '2026-03-07T09:15:00Z',
    deployedBy: 'Sarah Chen',
    duration: 5,
    features: ['PROJ-1245', 'PROJ-1252'],
  ...
  },
  {
    ...
    environment: 'dev',
    status: 'success',
    deployedAt: '2026-03-07T09:45:00Z',
    deployedBy: 'CI/CD Pipeline',
    duration: 4,
    features: ['PROJ-1245', 'PROJ-1246', 'PROJ-1252'],
    defectsFixes: ['PROJ-1248'],
  },
  {
    id: 'dep-005',
    ...
    environment: 'prod',
    status: 'success',
    deployedAt: '2026-03-01T14:00:00Z',
    deployedBy: 'CI/CD Pipeline',
    duration: 9,
    features: ['PROJ-1235', 'PROJ-1236'],
    defectsFixes: [],
  },
];
