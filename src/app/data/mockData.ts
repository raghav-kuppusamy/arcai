...
export const mockPullRequests: PullRequest[] = [
  {
    // PROJ-1245 (OAuth2 auth) is done — Sprint 1 completed → PR merged
    id: 'pr-001',
    number: 342,
  ...
  {
    // PROJ-1246 (Stripe) is in-review — code review approved, deployed to QA, awaiting QA sign-off before merge
    id: 'pr-002',
    number: 343,
    title: 'feat: Add Stripe payment gateway integration',
    author: 'Mike Johnson',
    status: 'approved',
    ...
    pipelineUrl: 'https://ci.example.com/pipelines/343',
  },
  {
    // PROJ-1248 (Mobile login crash) is done — Sprint 1 completed → PR merged
    id: 'pr-003',
    number: 344,
    title: 'fix: Resolve login page crash on mobile devices',
    author: 'Alex Kumar',
    status: 'merged',
    createdAt: '2026-02-18T09:00:00Z',
    updatedAt: '2026-02-21T14:30:00Z',
    mergedAt: '2026-02-21T14:30:00Z',
  ...
  {
    // PROJ-124 (API timeout on payment endpoints) is in-progress → fresh PR, pipeline running, critical defect
    id: 'pr-005',
    number: 345,
    title: 'fix: Resolve API timeout on payment service endpoints',
    author: 'Mike Johnson',
    status: 'open',
    ...
    aiReviewIssues: [
      {
        ...
        type: 'code-quality',
        severity: 'major',
        message: 'Retry logic does not implement exponential backoff, risking request storms',
        file: 'src/payment/api-client.ts',
        line: 83,
        suggestion: 'Implement exponential backoff with jitter on payment API retries',
        addressed: false,
      },
      {
        id: 'ai-003',
        type: 'security',
        severity: 'minor',
        message: 'Timeout value hardcoded — should be sourced from environment config',
        file: 'src/payment/api-client.ts',
        line: 21,
        suggestion: 'Move timeout config to environment variable with a safe default',
        addressed: false,
      },
    ],
  ...
  {
    // PROJ-123 (Safari login fix) is done — Sprint 1 completed → PR merged
    id: 'pr-006',
    number: 346,
    title: 'fix: Login page broken on Safari browser',
    author: 'Sarah Chen',
    status: 'merged',
    createdAt: '2026-02-10T11:00:00Z',
    updatedAt: '2026-02-20T15:30:00Z',
    mergedAt: '2026-02-20T15:30:00Z',
    reviewers: ['Alex Kumar'],
    commits: 4,
    filesChanged: 5,
    additions: 110,
    deletions: 42,
    linkedStory: 'PROJ-123',
    daysOpen: 0,
  },
  {
    // PROJ-128 (Update payment library deps) is refined — just raised as part of Sprint 2 prep
    id: 'pr-007',
    number: 347,
    title: 'chore: Update payment library dependencies to latest stable',
    author: 'Mike Johnson',
    status: 'open',
...
export const mockCommits: Commit[] = [
  {
    // PROJ-124 in-progress — latest commit on active fix branch today
    sha: 'f3a9d17',
    message: 'fix: add exponential backoff to payment API client',
    author: 'Mike Johnson',
  ...
  {
    // PROJ-128 refined — deps update PR just raised
    sha: 'e1b2c38',
    message: 'chore: bump stripe-js and payment-sdk to latest stable',
    author: 'Mike Johnson',
    date: '2026-03-08T08:30:00Z',
    branch: 'chore/update-payment-deps',
    linkedStory: 'PROJ-128',
  },
  {
    // PROJ-1246 in-review — last commit before PR was approved and deployed to QA
    sha: 'b7e1c45',
    message: 'feat: complete Stripe webhook handling and payment confirmation',
    author: 'Mike Johnson',
  ...
  {
    // PROJ-1245 done — final commit before merge to main (Sprint 1)
    sha: 'a3f2b91',
    message: 'feat: finalise OAuth2 token refresh and session management',
    author: 'Sarah Chen',
  ...
  {
    // PROJ-1248 done — merged Sprint 1 fix
    sha: 'c9d4a22',
    message: 'fix: resolve Safari-specific CSS layout breaking login form',
    author: 'Alex Kumar',
